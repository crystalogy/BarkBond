...
<div class="index-img-container">
    <ul class="index-hero-ul">
        ...
        <li><div class="image-container"><img class="hero-img-size-1" src="${pageContext.request.contextPath}petsIndex/hero1.png" alt="featured pet #1"><div class="feature-pet-name">Violet</div></div></li>
        <%--        <!-- https://www.petfinder.com/cat/nala-50058498/nc/apex/connies-kittens-nc1016/ -->--%>
        <li><div class="image-container"><img class="hero-img-size-2" src="${pageContext.request.contextPath}petsIndex/hero2.png" alt="featured pet #1"><div class="feature-pet-name">Nala</div></div></li>
        <%--        <!-- https://www.petfinder.com/dog/jem-16864734/tn/dresden/red-fern-animal-shelter-tn466/ -->--%>
        <li><div class="image-container"><img  class="hero-img-size-2" src="${pageContext.request.contextPath}petsIndex/hero3.png" alt="featured pet #1"><div class="feature-pet-name">Jem</div></div></li>
        ...
        <li><div class="image-container"><img class="hero-img-size-3" src="${pageContext.request.contextPath}petsIndex/hero5.png" alt="featured pet #1"><div class="feature-pet-name">Leo</div></div></li>
        <%--        <!-- https://www.petfinder.com/dog/dani-36788342/ny/albany/help-orphan-puppies-ny604/ -->--%>
        <li><div class="image-container"><img class="hero-img-size-4" src="${pageContext.request.contextPath}petsIndex/hero6.png" alt="featured pet #1"><div class="feature-pet-name">Dani</div></div></li>
...
<%--            https://www.petfinder.com/dog/luka-69987095/nc/raleigh/spca-of-wake-county-nc590/--%>
        <li><div class="image-container"><img class="hero-img-size-5" src="${pageContext.request.contextPath}petsIndex/hero7.png" alt="featured pet #1"><div class="feature-pet-name">Luka</div></div></li>
        ...
        <li><div class="image-container"><img class="hero-img-size-6" src="${pageContext.request.contextPath}petsIndex/hero8.png" alt="featured pet #1"><div class="feature-pet-name">Buddy</div></div></li>
            <%--        <!-- https://www.petfinder.com/dog/luna-72475699/nc/lexington/friends-in-need-animal-rescue-inc-nc648/ -->--%>
            <li><div class="image-container"><img class="hero-img-size-7" src="${pageContext.request.contextPath}petsIndex/hero9.png" alt="featured pet #1"><div class="feature-pet-name">Luna</div></div></li>
            <%--        <!-- https://www.petfinder.com/cat/winky-48859782/nc/salisbury/faithful-friends-animal-sanctuary-nc519/ -->--%>
            <li><div class="image-container"><img class="hero-img-size-2" src="${pageContext.request.contextPath}petsIndex/hero4.png" alt="featured pet #1"><div class="feature-pet-name">Winky</div></div></li>
            <%--        <!-- https://www.petfinder.com/cat/winky-48859782/nc/salisbury/faithful-friends-animal-sanctuary-nc519/ -->--%>
            <li><div class="image-container"><img class="hero-img-size-2" src="${pageContext.request.contextPath}petsIndex/hero4.png" alt="featured pet #1"><div class="feature-pet-name">Winky</div></div></li>
...
<%--    </div>--%>
            ...
            <div class="img-container">
                <img class="dogs-img" src="${pageContext.request.contextPath}dogs.png" alt="dog cat">
            </div>
