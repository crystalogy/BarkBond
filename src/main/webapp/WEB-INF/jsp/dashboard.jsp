...
<main>
    <div class="dashboard-panel-responsive-wrapper">
        <div class="dashboard-panel-content">
            <div class="dashboard-content-panel">
                <div class="dashboard-panel-vertical-tabs">
                    <a class="dashboard-panel-item" href="#" data-tab="search-content">Search</a>
                    <a class="dashboard-panel-item" href="#" data-tab="animals-content">Animals</a>
                    <a class="dashboard-panel-item" href="#" data-tab="users-content">Users</a>
                    <a class="dashboard-panel-item" href="#" data-tab="organizations-content">Organizations</a>
            ...
            <div class="content-main">
                ...
                <div id="search-content" class="dashboard-content" style="display: none;">
                    <div class="input-group mb-3">
                        <input name="term" id="dashboardSearchBar name" type="text" class="form-control" placeholder="Search..." value="${term}">
...
<%--<form>--%>
<%--    <div>--%>
<%--        <label for="name" class="form-label"><h4>Animal Search Tool</h4></label>--%>
...
<%--                                <c:forEach items="${animalList}" var="animal">--%>
<%--                                    <tr>--%>
<%--                                        <td class="editable" data-field="animalID">${animal.id}</td>--%>
