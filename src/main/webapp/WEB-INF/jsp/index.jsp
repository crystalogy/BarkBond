...
<div class="index-img-container">
    <ul class="index-hero-ul">
        ...
        <li><div class="image-container"><img class="hero-img-size-1" src="${pageContext.request.contextPath}images/hero1.png" alt="featured pet #1"><div class="feature-pet-name">Violet</div></div></li>
        <%--        <!-- https://www.petfinder.com/cat/nala-50058498/nc/apex/connies-kittens-nc1016/ -->--%>
        <li><div class="image-container"><img class="hero-img-size-2" src="${pageContext.request.contextPath}images/hero2.png" alt="featured pet #1"><div class="feature-pet-name">Nala</div></div></li>
        <%--        <!-- https://www.petfinder.com/dog/jem-16864734/tn/dresden/red-fern-animal-shelter-tn466/ -->--%>
        <li><div class="image-container"><img  class="hero-img-size-2" src="${pageContext.request.contextPath}images/hero3.png" alt="featured pet #1"><div class="feature-pet-name">Jem</div></div></li>
        <%--        <!-- https://www.petfinder.com/cat/winky-48859782/nc/salisbury/faithful-friends-animal-sanctuary-nc519/ -->--%>
        <li><div class="image-container"><img  class="hero-img-size-2" src="${pageContext.request.contextPath}images/hero4.png" alt="featured pet #1"><div class="feature-pet-name">Winky</div></div></li>
        <%--        <!-- petfinder.com/dog/leo-58583706/ca/burlingame/peninsula-humane-society-and-spca-ca39/ -->--%>
        <li><div class="image-container"><img class="hero-img-size-3" src="${pageContext.request.contextPath}images/hero5.png" alt="featured pet #1"><div class="feature-pet-name">Leo</div></div></li>
...
<%--            https://www.petfinder.com/dog/luka-69987095/nc/raleigh/spca-of-wake-county-nc590/--%>
        ...
        <li><div class="image-container"><img class="hero-img-size-6" src="${pageContext.request.contextPath}images/hero8.png" alt="featured pet #1"><div class="feature-pet-name">Buddy</div></div></li>
            ...
            <li><div class="image-container"><img class="hero-img-size-7" src="${pageContext.request.contextPath}images/hero9.png" alt="featured pet #1"><div class="feature-pet-name">Luna</div></div></li>
            <%--        <!-- https://www.petfinder.com/cat/winky-48859782/nc/salisbury/faithful-friends-animal-sanctuary-nc519/ -->--%>
            <li><div class="image-container"><img class="hero-img-size-2" src="${pageContext.request.contextPath}images/hero4.png" alt="featured pet #1"><div class="feature-pet-name">Winky</div></div></li>
            <%--        <!-- https://www.petfinder.com/cat/winky-48859782/nc/salisbury/faithful-friends-animal-sanctuary-nc519/ -->--%>
            <li><div class="image-container"><img class="hero-img-size-2" src="${pageContext.request.contextPath}images/hero4.png" alt="featured pet #1"><div class="feature-pet-name">Winky</div></div></li>
...
<%--    </div>--%>
            ...
            <div class="img-container">
                <img class="dogs-img" src="${pageContext.request.contextPath}\images\dogs.png" alt="dog cat">
            </div>
